    ...
    <Layout>
      <div className="space-y-6 border-r border-border/50">
        ...
        <div className="flex items-center justify-between border-r border-border/50">
          <div>
            <h1 className="text-3xl font-bold border-r border-border/50">Ad Exchanges</h1>
        ...
        <AnimatedCard variant="peach" animation="slide">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-r border-border/50">
              ...
              <Button 
                ...
                className="w-fit border-r border-border/50"
              >
                Clear
              </Button>
            </div>
                        ...
                        {exchanges.length === 0 ? (
                          ...
                          exchanges.map((exchange, index) => (
                            <TableRow key={exchange.id || index}>
                              ...
                              {columnOrder.includes('type') && (
                                <TableCell>
                                  <Badge variant="outline" className="bg-peach-50 text-peach-700 border-peach-200 dark:bg-peach-900/20 dark:text-peach-300 dark:border-peach-700 border-r border-border/50">
                                    {exchange.type}
                                  </Badge>
                                </TableCell>
                              )}
                              ...
                              {columnOrder.includes('creatives') && (
                                <TableCell className="text-center border-r border-border/50">
                                  <Badge variant="secondary" className="bg-lilac-50 text-lilac-700 dark:bg-lilac-900/20 dark:text-lilac-300 border-r border-border/50">
